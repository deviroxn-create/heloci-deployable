...
function buildQuery(latitude: number, longitude: number, radius: number, category: string) {
...
function normalizePlace(element: any, category: string, latitude: number, longitude: number): NearbyPlace | null {
  ...
  const distanceMeters = haversineDistance([latitude, longitude], [lat, lon]);
...
export async function getNearbyPlaces(latitude: number, longitude: number, category: string, radius = 2500) {
  ...
  const places = data.elements
    .map((element: any) => normalizePlace(element, category, latitude, longitude))
...
export function getNearbySchools(latitude: number, longitude: number) {
  return getNearbyPlaces(latitude, longitude, "schools");
}

export function getNearbyHospitals(latitude: number, longitude: number) {
  return getNearbyPlaces(latitude, longitude, "hospitals");
}

export function getNearbyTransit(latitude: number, longitude: number) {
  return getNearbyPlaces(latitude, longitude, "transit");
}

export function getNearbyGroceries(latitude: number, longitude: number) {
  return getNearbyPlaces(latitude, longitude, "groceries");
}

export function getNearbyPharmacies(latitude: number, longitude: number) {
