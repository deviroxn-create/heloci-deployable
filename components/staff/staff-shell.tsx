...
export function StaffShell({ title, description, children, actions }: StaffShellProps) {
        ...
        <main className="min-h-screen">
          <div className="sticky top-0 z-30 border-b border-border bg-white/90 backdrop-blur px-6 py-4">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand">Staff</p>
